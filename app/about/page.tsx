...
export default function About() {
  return (
    <section className="relative overflow-hidden bg-primary-900 text-white py-24 px-6 md:px-12 lg:px-20">
      {/* 🌫️ Background Glow */}
      <div className="absolute top-[-100px] left-[-80px] w-[400px] h-[400px] bg-primary-700/60 blur-[140px] rounded-full" />
      <div className="absolute bottom-[-100px] right-[-80px] w-[400px] h-[400px] bg-primary-500/20 blur-[140px] rounded-full" />

      {/* 🧠 Content */}
      <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
        <h1 className="text-4xl md:text-5xl font-extrabold bg-primary-500 bg-clip-text text-transparent">
          About <span className="text-white">APTS TECH</span>
        </h1>
        <p className="text-indigo-100/80 text-lg max-w-3xl mx-auto leading-relaxed">
          Founded in <strong>2022</strong>, <span className="text-primary-500 font-semibold">APTS TECH</span> is a next-generation technology company
          delivering cutting-edge software, AI, and cybersecurity solutions for global enterprises.
          <br />
          We empower businesses to achieve <span className="text-primary-500 font-medium">digital transformation</span> through
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 mt-12">
          {[
            ...
            >
              <h3 className="text-3xl font-bold text-primary-500">{stat.value}</h3>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-white/5 hover:bg-white/10 transition-all p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-semibold text-primary-500 mb-4">Our Mission</h3>
          ...
          <div className="bg-white/5 hover:bg-white/10 transition-all p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-semibold text-primary-500 mb-4">Our Vision</h3>
            <p className="text-indigo-100/80 leading-relaxed">
