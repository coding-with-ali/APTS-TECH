  ...
  return (
    <section className="py-24 bg-gray-50">
      ...
      <div className="text-center mb-12 px-6">
        <h1 className="text-5xl md:text-6xl font-extrabold bg-primary-500 bg-clip-text text-transparent">
          <span className="text-primary-900">Current</span> Openings
        </h1>
        ...
        {filteredCareers.map(c => (
          ...
          >
            <div className="p-6 flex flex-col justify-between">
              {/* Job Info */}
              <div>
                <h3 className="text-xl font-semibold text-primary-900 mb-3  transition-colors">
                  {c.title}
                </h3>
              ...
              <a
                ...
                className="mt-6 w-full text-center bg-primary-900 text-white font-semibold px-5 py-3 rounded-2xl hover:bg-primary-700 transition-all"
              >
                Apply Now
              </a>
            </div>
